...
class StringConstants {
    ...
    static let deleteVisitNotAllowedMessage = "Deletion of Visit not allowed in offline, Please try again"
    
    static let deleteEventMessage = "Deletion of Event has failed, Please try again"
    static let deleteEventNotAllowedMessage = "Deletion of Event not allowed in offline, Please try again"
