...
class PlanVisitViewController: UIViewController, CloseAccountViewDelegate {
    ...
    func editAccountScreen()  {
        ...
        let accounts = GlobalWorkOrderArray.accountArray
    ...
    func getAccountData(searchStr: String) -> [Account] {
        let account = GlobalWorkOrderArray.accountArray
...
extension PlanVisitViewController : UITextFieldDelegate{
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        case kAccountTxtTag:
            ...
            searchAccounts = GlobalWorkOrderArray.accountArray
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool
    {
        if(textFieldTag == kAccountTxtTag) {
            if string.isEmpty {
                self.searchAccounts = GlobalWorkOrderArray.accountArray
