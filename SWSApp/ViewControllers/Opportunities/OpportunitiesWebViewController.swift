...
class OpportunitiesWebViewController : UIViewController , WKNavigationDelegate{
    ...
    func loadWebView(){
        ...
        let authUrl: String = instanceUrl.description + StringConstants.secureUrl + accessToken + StringConstants.retUrl + StringConstants.opportunitiesUrl + opportunityWebViewId + StringConstants.opportunityEndUrl
